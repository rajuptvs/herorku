      ...
      <div class="col-lg-10 col-xl-8">
        <div class="card" style={{borderRadius: "10px"}}>
          <div class="card-header px-4 py-5">
            ...
            {bookingsData && bookingsData.length == 0 && <h5 class="text-muted mb-0">No Bookings!!! <span style={{color: "#a8729a"}}>{userData.username}</span></h5>}
                ...
                return <><NavLink to={bookingPath}>
                    <div class="card-body">
                      ...
                      <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-md-2 text-center d-flex  justify-content-center align-items-center">
                          {/* <p class="text-muted mb-0 small"><b>Check In &nbsp;</b> {moment.unix(booking.checkIn).format("MM/DD/YY")}</p> */}
                          <p class="text-muted mb-0 small"><b>Check In &nbsp;</b> {moment(moment(new Date(booking?.checkIn))).format("MM/DD/YY")}</p>
                        </div>
                        <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                          <p class="text-muted mb-0 small"><b>Check Out </b>{moment(moment(new Date(booking?.checkOut))).format("MM/DD/YY")}</p>
                        </div>
                        {/* <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
