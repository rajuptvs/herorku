                              ...
                              <div class="form-input col-md-4 col-sm-6 mt-3">
                                ...
                                <input type="text" name="" placeholder="Destination" name='destination' required=""value={form.destination} onChange={handleChange}></input> 
                                  ...
                                  <div class="form-input col-md-4 col-sm-6 mt-3">
                                      ...
                                      <input type="date" name="" placeholder="Date"  required="" min={disablePastDate()} name='checkOutDate' value={form.checkOutDate} onChange={handleChange}></input>
                                  </div>
                                  <div class="form-input col-md-4 col-sm-6 mt-3">
                                      <label>Rooms</label>
                                  ...
                                  <div class="bottom-btn col align-self-center">
                                      ...
                                      <NavLink to="/hotels"><button class="btn btn-style btn-primary w-50 px-2 " onClick={handleSearch}>Search</button></NavLink>
