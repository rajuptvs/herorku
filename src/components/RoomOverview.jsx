                    ...
                    <div className="row my-4">
                        ...
                        <div className="col-md-6 col-12 my-auto">
                            <div className="col-md-6 col-12 float-right">
                                <NavLink to="/mybookings" ><button className="btn btn-block"  data-toggle="modal" data-target="#thanks" onClick={handleSubmit} style={{color: "white", backgroundColor: "#d63447"}}>Confirm Booking</button> </NavLink>
                            </div>
                        </div>
                        {bookingSuccess ? (
